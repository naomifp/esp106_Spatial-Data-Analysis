...
To know the number of individual blue whales that at least once come to West Coast MPAs, I look first for the number of individual blue whales in all MPAs which has result of 141 individual blue whales.
...
Then, I explore 3 ways to obtain the fraction of individual blue whales that once enter west coast MPAs which resulted as listed below.
...
I suspect there is abnormality in the logic of subset function I use, which results in only 110 individual blue whales, not 141 as I expect.
