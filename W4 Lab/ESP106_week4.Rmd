...
```
It shows that the row number #141 has the maximum data.
...
allgauge[141,]
```
It is found that on row number #141, the outlier data happened on October 2012.
On October 29-30, 2012, there was a Hurricane Sandy on New York.
...
```
Based on the above summary of Linear Regression of MHHW and Date relationship, the estimated coefficient of Date column is 0.00002732 with p-value of 5.314e-14 (less than 0.05), which is significant.
...
```
The linear equation for the the annual time frame is 
*MHHW = 2.732e-05(Date) - 0.3399*
And the mean increase in sea-level over the 10 year time frame from 2011-2020 is *-0.240182*
