...
[Another way to show this using dplyr package is by using top_n function
to pick 5 countries with highest "total" value, then using arrange
function to sort the countries in descending
...
minimum value of 12 and maximum value of 703,165.]{style="color:orange"}
...
per events, 5 countries that have the worst plastic pollution
are:]{style="color:orange"}
