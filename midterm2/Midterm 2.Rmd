...
answer: problem is grid cells are actually have different sizes because the globe shape is round.. northern part may be smaller in cell size
context: no big deal with china because not too north
solution: computing the cells size then find the mean from all cells
...
#or reshape(china.df, vaarying=nms, times=nms, v.names="fraction", direction="long", timevar="landuse")
