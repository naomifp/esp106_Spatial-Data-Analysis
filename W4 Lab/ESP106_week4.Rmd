...
```
Based on the above summary of Linear Regression of MHHW and Date relationship, the estimated coefficient of Date column is 0.00002732 with p-value of 5.314e-14, which is insignificant.
...
lin_mhhw
```
So, the linear equation for the the annual time frame will be 
MHHW = 2.732e-05(Date) - 0.3399

And the linear equation for the the 10-year time frame will be
MHHW = 2.732e-05(Date) - 3.399
